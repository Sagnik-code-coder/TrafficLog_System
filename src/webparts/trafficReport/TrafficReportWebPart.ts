...
import * as strings from 'TrafficReportWebPartStrings';
import TrafficReport from './components/TrafficReport';
import { ITrafficReportProps } from './components/ITrafficReportProps';

export interface ITrafficReportWebPartProps {
  description: string;
}

export default class TrafficReportWebPart extends BaseClientSideWebPart<ITrafficReportWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<ITrafficReportProps> = React.createElement(
      TrafficReport,
      {
                        ...
                        <div class="row" style="width: 100%; padding-top:20px;">
                            ...
                            <div id="MTDTrendReport" style="width:100%">
                                <table id="MTDTrend" class="table table-striped table-bordered dt-responsive nowrap data-entry" cellspacing="0" style="display:none;">
                                    <thead>
                                        <tr><th rowspan="2" tkey="Model">Model</th><th colspan="20" tkey="MTDTrend">MTD Trend</th></tr>
  ...
  protected onInit(): Promise<void> {
    ...
    SPComponentLoader.loadScript('https://y3mbk.sharepoint.com/sites/SharePointCRUD/SiteAssets/TrafficLog/js/DetailReport.js');
